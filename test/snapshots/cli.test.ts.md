...
> Snapshot 1
    ...
    ----␊
    getNodeNames␊
    🇺🇸US 1, 🇺🇸US 2, 🇺🇸US 3, 🇺🇸 US, Snell, HTTPS, trojan node, 🚀 火箭 trojan node, 🎉 foobar trojan node, 🇺🇸US 1, 🇺🇸US 2, 🇺🇸US 3, 🇺🇸US 4, 测试 1, 测试 2, 测试 tls, ss1, ss2, ss3, ss4, ss-wss, 测试中文, US GIA, HK GIA␊
    ----␊
    getQuantumultXNodes␊
    ...
    HTTPS = http,us.example.com,443,username,"password"␊
...
> Snapshot 2
    ...
    http 1 = http,server,443,username,"password"␊
    http 2 = https,server,443,username,"password"␊
    ss4 = Shadowsocks,server,443,chacha20-ietf-poly1305,"password",tls,example.com␊
    ----␊
    clashProxyConfig␊
    ␊
