export const DEP001 =
  'nowHandler 已不推荐使用，请参考 http://bit.ly/2q5daCK 尽快更新您的代码'
export const DEP002 =
  'udp-relay 的值已改为布尔类型，字符串类型依然可用但推荐更改'
export const DEP003 = 'useProvider 将在之后版本改为默认使用严格模式'
export const DEP004 = 'discardProviders 将在之后版本改为默认使用严格模式'
export const DEP005 =
  'surgioConfig.surgeConfig.shadowsocksFormat: "custom" 已不推荐使用，请改为 "ss"'
export const DEP006 =
  'surgioConfig.surgeConfig.v2ray: "external" 已不推荐使用，请改为 "native"'
export const DEP007 =
  'patchYamlArray 已不推荐使用，请改为 Clash 规则格式处理器，详情请阅读 https://url.royli.dev/xr9mj'
export const DEP008 =
